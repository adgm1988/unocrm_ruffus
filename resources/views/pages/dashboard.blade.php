	...
	<table class="table table-bordered">
		...
		<tr style="background-color:lightgray;">			
				...
				<td style="padding:3px; min-width:200px; max-width:200px; ">
					...
					<div style="width:98%; box-shadow: 2px 2px #888888; border: 1px solid gray; background-color:{{ $prospecto->indicador }}; border-bottom:5px solid {{ $etapa->color }} ; border-radius:4px; padding:5px; margin:auto; margin-bottom:5px; ">
						<div>
